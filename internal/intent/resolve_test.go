...
func TestResolveDailyUsageIntents(t *testing.T) {
	...
	cases := []struct {
		...
		{"what_is_my_ip", []string{"what", "is", "my", "ip"}, "show_ip_addresses", map[string]string{}},
		{"show_my_ip", []string{"show", "my", "ip"}, "show_ip_addresses", map[string]string{}},
		{"where_am_i", []string{"where", "am", "i"}, "current_dir", map[string]string{}},
