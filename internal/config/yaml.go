...
func Encode(cfg Config, w io.Writer) error {
	lines := []string{
		...
		"  timeout: " + strconv.Itoa(cfg.Providers.Timeout),
		"  ollama:",
		...
		"  gemini:",
		"    api_key: " + quoteIfNeeded(cfg.Providers.Gemini.APIKey),
		...
		"  ai_command_generation: " + strconv.FormatBool(cfg.Features.AICommandGeneration),
		"",
		"cache:",
